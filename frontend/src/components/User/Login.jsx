...
const Login = () => {
    ...
    return (
        <>
            <MetaData title="Login | Mayuri Fashions" />
                            ...
                            <form onSubmit={handleLogin}>
                                <div className="flex flex-col w-full gap-4">
                                    ...
                                    <div className="flex flex-col gap-2.5 mt-2 mb-32">
                                        <p className="text-xs text-primary-grey text-left">By continuing, you agree to our <a href="" className="text-primary-blue"> Terms of Use</a> and <a href="" className="text-primary-blue"> Privacy Policy.</a></p>
