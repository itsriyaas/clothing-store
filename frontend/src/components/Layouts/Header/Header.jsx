    ...
    <header className="bg-primary-blue fixed top-0 py-2.5 w-full z-10">
      <div className="w-full sm:w-9/12 px-1 sm:px-4 m-auto flex justify-between items-center relative">
        ...
        <div className="flex items-center flex-1 gap-2">
          ...
          {/* Show searchbar on larger screens or when toggled on mobile */}
          <div className={`flex-1 ${showSearch ? "block" : "hidden"} sm:block`}>
            <Searchbar />
          </div>
        </div>

        {/* Right nav items */}
        <div className="flex items-center justify-between ml-1 sm:ml-0 gap-2 sm:gap-7 relative">
