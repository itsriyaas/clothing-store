                                ...
                                <div className="flex flex-col gap-2 mb-4">
                                    ...
                                    {Array(2).fill("").map((el, i) => (
                                        <p className="text-sm flex items-center gap-1" key={i}>
                                            ...
                                            <span className="font-medium ml-2">Bank Offer</span> 15% Instant discount on first Mayuri Fashions Pay Later order of 500 and above <Link className="text-primary-blue font-medium" to="/">T&C</Link>
                                        </p>
                                    ))} */}
                                    {/* <!-- banks offers --> */}
                                    ...
                                    <div className="w-full mt-4 pb-4 rounded-sm border flex flex-col">
                                        <h1 className="px-6 py-4 border-b text-2xl font-medium">Product Details</h1>
